defmodule IBRC do
  ...
  def format_float(f), do: :erlang.float_to_binary(f, decimals: 1)

  def make_measurements(:small), do: do_make_measurements(50_000_000)
  def make_measurements(:large), do: do_make_measurements(1_000_000_000)

  def do_make_measurements(count) do
    try do
      ...
      {:ok, {elapsed, _}} =
        File.open("./measurements_ex.txt", [:write, :utf8], fn file ->
          :timer.tc(fn ->
            last = count - 1
            1..last
            |> Stream.map(fn x ->
              ...
              dec = (:rand.uniform(10) - 1) * 0.1
              num = (temp + dec) |> format_float()
